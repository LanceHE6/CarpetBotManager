...
public final class CommandExceptions {
    ...
    public static final SimpleCommandExceptionType NOT_BOT_PREFIX =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.not_bot_prefix",
    ...
    public static final SimpleCommandExceptionType BOT_NOT_FOUND =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.bot_not_found",
                    "Bot preset not found."));
    public static final SimpleCommandExceptionType BOT_ALREADY_EXISTS =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.bot_already_exists",
                    "A bot preset with this name already exists."));
    public static final SimpleCommandExceptionType GROUP_NOT_FOUND =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.group_not_found",
                    "Bot group not found."));
    public static final SimpleCommandExceptionType GROUP_ALREADY_EXISTS =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.group_already_exists",
                    "A bot group with this name already exists."));
    public static final SimpleCommandExceptionType BOTS_NOT_FOUND_FOR_GROUP =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.bots_not_found_for_group",
    ...
    public static final SimpleCommandExceptionType ALREADY_IN_AUTOLOAD =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.already_in_autoload",
                    "This bot is already in the auto-load list."));
    public static final SimpleCommandExceptionType NOT_IN_AUTOLOAD =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.not_in_autoload",
                    "This bot is not in the auto-load list."));
    public static final SimpleCommandExceptionType GROUP_ALREADY_IN_AUTOLOAD =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.group_already_in_autoload",
                    "This group is already in the auto-load list."));
    public static final SimpleCommandExceptionType GROUP_NOT_IN_AUTOLOAD =
            new SimpleCommandExceptionType(Text.translatableWithFallback("carpetbotmanager.error.group_not_in_autoload",
